...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center text-zinc-200 dark:text-zinc-200 pb-10 relative overflow-hidden bg-zinc-50 dark:bg-black transition-colors duration-300">
      ...
      {/* Capa 2: Glow (Solo visible en Dark Mode para no ensuciar el Light) */}
      <div className="hidden dark:block absolute left-0 right-0 top-[-10%] h-[1000px] w-[1000px] rounded-full bg-indigo-500 opacity-20 blur-[100px] m-auto pointer-events-none"></div>
      
      {/* Capa 3: Viñeta (Solo Dark) */}
      <div className="hidden dark:block absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,black_100%)] pointer-events-none"></div>
      ...
      <main className="relative w-full max-w-5xl px-4 mt-8 flex flex-col gap-8">
        ...
        {session && (
          <div className="bg-zinc-50 dark:bg-black transition-colors duration-300 rounded-xl p-6 w-full shadow-2xl relative overflow-hidden">
        ...
        <div className="w-full">
          <h2 className="text-xl font-medium text-zinc-900 dark:text-zinc-100 mb-6 tracking-tight">Live Monitors</h2>
